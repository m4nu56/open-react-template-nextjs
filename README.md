...
This project is a fork from [https://github.com/cruip/open-react-template](https://github.com/cruip/open-react-template) adapted to be run/deploy with nextjs/vercel.
